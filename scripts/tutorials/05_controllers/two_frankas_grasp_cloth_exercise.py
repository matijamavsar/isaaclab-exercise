...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    ...
    while simulation_app.is_running():
        ...
        if count % 800 == 0:
            ...
            # TODO: set joint targets so the gripper opens (last two values)
            # close: 0.0, open: 0.04
        ...
        if not cloth_grasped and count >= 300:
            ...
            # TODO: change joint targets so the gripper will close
            ...
            # TODO: change commands so the robots will lift the cloth
