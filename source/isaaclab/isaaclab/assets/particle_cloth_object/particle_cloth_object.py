...
from .particle_cloth_object_data import ParticleClothObjectData

if TYPE_CHECKING:
    from .particle_cloth_object_cfg import ParticleClothObjectCfg


class ParticleClothObject(AssetBase):
    ...
    cfg: ParticleClothObjectCfg
    """Configuration instance for the deformable object."""

    def __init__(self, cfg: ParticleClothObjectCfg):
    ...
    @property
    def data(self) -> ParticleClothObjectData:
        return self._data
    ...
    @property
    def material_physx_view(self) -> physx.ParticleMaterialView | None:
    ...
    def _initialize_impl(self):
        ...
        self._root_physx_view = self._physics_sim_view.create_particle_cloth_view(
            root_prim_path_expr.replace(".*", "*") + '/Cloth')
        ...
        self._data = ParticleClothObjectData(self.root_physx_view, self.device)
