...
class ImageEncoder(nn.Module):
    def __init__(self, out_dim=256):
        ...
        # for 84x84 input → 64 × 7 × 7
        self.fc = nn.Linear(50176, out_dim)
...
class FrankaDMPClothPlaceEnvCfg(DirectRLEnvCfg):
    ...
    cuboid = RigidObjectCfg(
        ...
        spawn=sim_utils.CuboidCfg(
            ...
            mass_props=sim_utils.MassPropertiesCfg(mass=500.5),
...
class FrankaDMPClothPlaceEnv(DirectRLEnv):
    ...
    def __init__(self, cfg: FrankaDMPClothPlaceEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        self.image_encoder = ImageEncoder(out_dim=256).to(self.device)
        for p in self.image_encoder.parameters():
            p.requires_grad = True   # or False if frozen
