...
class FrankaDMPClothPlaceEnvCfg(DirectRLEnvCfg):
    ...
    ### Robots
    # FRANKA_PANDA_HIGH_PD_CFG.spawn.usd_path = "/workspace/isaaclab/source/isaaclab_tasks/isaaclab_tasks/sim/panda_instanceable.usd"
...
class FrankaDMPClothPlaceEnv(DirectRLEnv):
    ...
    def _setup_scene(self):
        ...
        if not self.cfg.nice_render:
            ...
            self.setup_clean_stage(renderer="HydraStorm") 
    ...
    def compute_rewards(self):
        ...
        ### TODO: get corners and positions of the cloth
        ### Hint: for positions, use self._cloth_plain.root_phsyx_view
        ...
        count = 0.0
        ### TODO: calculate spread reward by adding all distances between corners

        # Corner X and direction rewards
        ### TODO: get free and grasped corners (free are 3rd and 4th)
        ### Hint: remember to use self.scene.env_origins

        ### TODO: calculate rewards, multiply by reward scale -- self._rewards[""].scale
        ### Hint: you can use mean cloth height for height reward
        rewards["height_reward"] = ...
        rewards["spread_reward"] = ...
        rewards["corner_x_reward"] = ...
        rewards["direction_reward"] = ...
    ...
    def _get_observations(self) -> torch.Tensor:
        ...
        ### TODO: form history abs observations, take every 48th sample

        self.corner_traj = self.prev_corners_buf.permute(1,0,2)
        ### TODO: form history corner observations, take everys 48th sample
