...
from isaaclab.assets import ArticulationCfg, AssetBaseCfg, ParticleClothObjectCfg
...
@configclass
class ClothSceneCfg(InteractiveSceneCfg):
    """Configuration for the cloth lift scene with two robots and a cloth.
    ...
    object: ParticleClothObjectCfg = MISSING
...
class CommandsCfg:
    ...
    object_pose_1 = mdp.UniformPoseCommandCfg(
        ...
        ranges=mdp.UniformPoseCommandCfg.Ranges(
            pos_x=(0.3, 0.8), pos_y=(-0.8, 0.8), pos_z=(0.0, 1.0), roll=(-0.0, 0.0), pitch=(-0.0, 0.0), yaw=(-0.0, 0.0)
        ),
    )
...
class ActionsCfg:
    ...
    arm_action_1: mdp.DifferentialInverseKinematicsActionCfg = MISSING
    arm_action_2: mdp.DifferentialInverseKinematicsActionCfg = MISSING
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # object_position_1 = ObsTerm(func=mdp.cloth_position_in_robot_root_frame, params={"robot_cfg": SceneEntityCfg("robot_1")})
        # object_position_2 = ObsTerm(func=mdp.cloth_position_in_robot_root_frame, params={"robot_cfg": SceneEntityCfg("robot_2")})
...
class RewardsCfg:
    ...
    reaching_object_1 = RewTerm(func=mdp.object_ee_distance, 
                                params={"ee_frame_cfg": SceneEntityCfg("ee_frame_1")}, 
                                weight=20.0)
    reaching_object_2 = RewTerm(func=mdp.object_ee_distance, 
                                params={"ee_frame_cfg": SceneEntityCfg("ee_frame_2")}, 
                                weight=20.0)

    # lifting_object = RewTerm(func=mdp.object_mean_height, weight=3.0)
...
@configclass
class ClothLiftEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the lifting environment."""

    # Scene settings
    scene: ClothSceneCfg = ClothSceneCfg(num_envs=4096, env_spacing=5.0)
    # Basic settings
